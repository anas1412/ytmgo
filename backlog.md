...
| **Artist pages** — top songs and full discography, from any track; albums always open inside their artist | `ytmusic.Artist`, `[A]` |
| **Copy a track's link** — wl-copy / xclip / xsel / pbcopy, host configurable | `internal/clipboard`, `[u]` |
